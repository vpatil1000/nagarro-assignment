 ...
 */
package org.nagacc.fulfilmentprocess.test.jobs;
...
import org.nagacc.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = NagaccFulfilmentProcessConstants.ORDER_PROCESS_NAME;
