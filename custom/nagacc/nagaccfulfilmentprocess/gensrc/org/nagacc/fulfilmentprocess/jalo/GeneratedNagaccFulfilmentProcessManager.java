 ...
 * --- Generated at 10-May-2025, 1:17:18 am                     ---
 * ----------------------------------------------------------------
 */
...
/**
 * Generated class for type <code>NagaccFulfilmentProcessManager</code>.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedNagaccFulfilmentProcessManager extends Extension
{
	...
	{
		return (Boolean)item.getProperty( ctx, NagaccFulfilmentProcessConstants.Attributes.ConsignmentProcess.DONE);
	}
	...
	{
		item.setProperty(ctx, NagaccFulfilmentProcessConstants.Attributes.ConsignmentProcess.DONE,value);
	}
	...
	{
		return NagaccFulfilmentProcessConstants.EXTENSIONNAME;
	}
	...
	{
		return (Boolean)item.getProperty( ctx, NagaccFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT);
	}
	...
	{
		item.setProperty(ctx, NagaccFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT,value);
	}
	...
	{
		return (EnumerationValue)item.getProperty( ctx, NagaccFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE);
	}
	...
	{
		item.setProperty(ctx, NagaccFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE,value);
	}
