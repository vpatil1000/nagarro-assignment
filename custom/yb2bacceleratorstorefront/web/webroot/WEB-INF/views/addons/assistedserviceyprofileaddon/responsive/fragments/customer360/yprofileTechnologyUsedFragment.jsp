...
<c:set var="name" value="${fn:split(fragmentData.name, ' ')[0]}" scope="page"/>
...
<div class="asm__customer360-overview-info-uses">
    <div class="asm__customer360-overview-info-headline">
        <spring:theme code="text.customer360.customer_uses" arguments="${name}" text="${name} USES" htmlEscape="true"/> 
    </div>
    <c:choose>
