 ...
 */
package org.nagacc.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(NagaccFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(NagaccFulfilmentProcessConstants.PARENT_PROCESS);
